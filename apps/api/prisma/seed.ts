...
interface ModuleSeed {
  code: string;
  name: string;
  category: 'core' | 'operations' | 'finance' | 'hr' | 'integration' | 'addon';
  defaultRoute: string;
  icon: string;
  sortOrder: number;
  description: string;
...
interface PlanSeed {
  code: 'starter' | 'standard' | 'professional' | 'enterprise' | 'custom';
  name: string;
  description: string;
  monthlyPrice: number;
  yearlyPrice: number;
...
const MODULES: ModuleSeed[] = [
  ...
  },
  {
    ...
    icon: 'credit_card',
    sortOrder: 78,
    description: 'POS cihaz tanımları ve işlemleri',
  },
  {
    code: 'depo',
    name: 'Depo',
  ...
  },
  {
    ...
    name: 'Stok Sayım',
    category: 'operations',
    defaultRoute: '/stock-counts',
    icon: 'fact_check',
    sortOrder: 85,
    description: 'Sayım başlık ve kalemleri',
  },
  {
    code: 'iade',
    name: 'İade',
    category: 'operations',
    defaultRoute: '/returns',
    icon: 'assignment_return',
    sortOrder: 88,
    description: 'Satış ve alım iadeleri',
  },
  {
    code: 'raporlar',
    name: 'Raporlar',
  ...
  },
  {
    ...
    icon: 'inventory',
    sortOrder: 115,
    description: 'Personel zimmet takibi',
  },
  {
    code: 'servis',
    name: 'Servis / Bakım',
    ...
    icon: 'build',
    sortOrder: 120,
    description: 'Servis ve bakım talepleri',
  },
  {
    code: 'bayi_portali',
    name: 'Bayi Portalı',
    ...
    icon: 'storefront',
    sortOrder: 130,
    description: 'Bayi ve müşteri portalı',
  },
  {
    code: 'api_webhook',
    name: 'API & Webhook',
    category: 'integration',
    defaultRoute: '/api-webhooks',
    icon: 'webhook',
    sortOrder: 140,
    description: 'Public API ve webhook entegrasyonları',
  },
  {
    code: 'erp_entegrasyon',
    name: 'ERP Entegrasyonu',
    category: 'integration',
    defaultRoute: '/erp',
    icon: 'sync_alt',
    sortOrder: 145,
    description: 'Mikro, Logo, Netsis, Paraşüt adaptörleri',
  },
  {
    code: 'veri_tasima',
    name: 'Veri Taşıma',
    ...
    icon: 'upload_file',
    sortOrder: 150,
    description: 'Excel ve ERP veri taşıma',
  },
  {
    code: 'log_audit',
    name: 'Log & Audit',
  ...
  },
  {
    ...
    icon: 'smart_toy',
    sortOrder: 220,
    description: 'Modül yardımı ve bilgi tabanı',
  },
  {
    code: 'ayarlar',
    name: 'Ayarlar',
...
const PERMISSIONS: PermissionSeed[] = [
  {
    code: 'cari:customer:view',
    module: 'cari',
    resource: 'customer',
    action: 'view',
    description: 'Cari listesi/detayı görüntüleme',
  },
  {
    code: 'cari:customer:create',
    module: 'cari',
    resource: 'customer',
    action: 'create',
  ...
  {
    code: 'cari:customer:delete',
    module: 'cari',
    resource: 'customer',
    action: 'delete',
    description: 'Cari silme',
  },
  {
    code: 'cari:customer:export',
    module: 'cari',
    resource: 'customer',
    action: 'export',
    description: 'Cari dışa aktarma',
  },
  {
    code: 'cari:customer:import',
    module: 'cari',
    resource: 'customer',
    action: 'import',
    description: 'Cari içe aktarma',
  },
  {
    code: 'stok:product:view',
    module: 'stok',
    resource: 'product',
    action: 'view',
    description: 'Ürün görüntüleme',
  },
  {
    code: 'stok:product:create',
    module: 'stok',
    resource: 'product',
    action: 'create',
  ...
  {
    code: 'stok:product:export',
    module: 'stok',
    resource: 'product',
    action: 'export',
    description: 'Ürün dışa aktarma',
  },
  {
    code: 'stok:product:import',
    module: 'stok',
    resource: 'product',
    action: 'import',
    description: 'Ürün içe aktarma',
  },
  {
    code: 'satis:sale:view',
    module: 'satis',
    resource: 'sale',
    action: 'view',
    description: 'Satış görüntüleme',
  },
  {
    code: 'satis:sale:create',
    module: 'satis',
    resource: 'sale',
    action: 'create',
  ...
  {
    code: 'satis:sale:update',
    module: 'satis',
    resource: 'sale',
    action: 'update',
    description: 'Satış düzenleme',
  },
  {
    code: 'satis:sale:cancel',
    module: 'satis',
    resource: 'sale',
    action: 'cancel',
    description: 'Satış iptal',
  },
  {
    code: 'satis:sale:export',
    module: 'satis',
    resource: 'sale',
    action: 'export',
    description: 'Satış dışa aktarma',
  },
  {
    code: 'siparis:order:view',
    module: 'siparis',
    resource: 'order',
    action: 'view',
  ...
  {
    code: 'siparis:order:update',
    module: 'siparis',
    resource: 'order',
    action: 'update',
    description: 'Sipariş düzenleme',
  },
  {
    code: 'siparis:order:cancel',
    module: 'siparis',
    resource: 'order',
    action: 'cancel',
    description: 'Sipariş iptal',
  },
  {
    code: 'tahsilat:collection:view',
    module: 'tahsilat',
    resource: 'collection',
    action: 'view',
    description: 'Tahsilat görüntüleme',
  },
  {
    code: 'tahsilat:collection:create',
    module: 'tahsilat',
    resource: 'collection',
    action: 'create',
    description: 'Tahsilat oluşturma',
  },
  {
    code: 'tahsilat:collection:cancel',
    module: 'tahsilat',
    resource: 'collection',
    action: 'cancel',
    description: 'Tahsilat iptal',
  },
  {
    code: 'kasa:cash_account:view',
    module: 'kasa',
    resource: 'cash_account',
    action: 'view',
    description: 'Kasa görüntüleme',
  },
  {
    code: 'kasa:cash_account:create',
    module: 'kasa',
    resource: 'cash_account',
    action: 'create',
    description: 'Kasa oluşturma',
  },
  {
    code: 'kasa:cash_movement:view',
    module: 'kasa',
    resource: 'cash_movement',
    action: 'view',
    description: 'Kasa hareketi görüntüleme',
  },
  {
    code: 'kasa:cash_movement:create',
    module: 'kasa',
    resource: 'cash_movement',
    action: 'create',
    description: 'Kasa hareketi oluşturma',
  },
  {
    code: 'raporlar:report:view',
    module: 'raporlar',
    resource: 'report',
    action: 'view',
  ...
  {
    code: 'log_audit:audit_log:view',
    module: 'log_audit',
    resource: 'audit_log',
    action: 'view',
    description: 'Audit log görüntüleme',
  },
  {
    code: 'ayarlar:user:view',
    module: 'ayarlar',
    resource: 'user',
    action: 'view',
  ...
  {
    code: 'ayarlar:user:update',
    module: 'ayarlar',
    resource: 'user',
    action: 'update',
    description: 'Kullanıcı düzenleme',
  },
  {
    code: 'ayarlar:user:delete',
    module: 'ayarlar',
    resource: 'user',
    action: 'delete',
  ...
  {
    code: 'bildirim:notification:view',
    module: 'bildirim',
    resource: 'notification',
    action: 'view',
    description: 'Bildirim görüntüleme',
  },
  {
    code: 'bildirim:notification:update',
    module: 'bildirim',
    resource: 'notification',
    action: 'update',
    description: 'Bildirim güncelleme',
  },
];
...
const PLANS: PlanSeed[] = [
  {
    ...
    webhookLimit: 0,
    storageMbLimit: 2048,
    modules: ['dashboard', 'cari', 'stok', 'satis', 'tahsilat', 'kasa', 'raporlar'],
  },
  {
    code: 'standard',
    name: 'Standart',
  ...
  },
  {
    code: 'enterprise',
    name: 'Kurumsal',
    description: 'Büyük ölçekli firmalar için sınırsız',
    monthlyPrice: 0,
    yearlyPrice: 0,
    userLimit: 9999,
    branchLimit: 9999,
...
async function main(): Promise<void> {
  ...
  console.log(
    `   ${MODULES.length} modül, ${PERMISSIONS.length} permission, ${PLANS.length} plan, 1 süper admin`,
  );
    ...
    const sampleNotifications = [
      {
        ...
        message:
          'Demo firmanız başarıyla oluşturuldu. Standart paket 14 gün ücretsiz deneme olarak aktiftir.',
        link: '/dashboard',
        isRead: false,
      ...
      },
      {
        ...
        message:
          'Standart paket deneme süreniz 14 gün sonra sona erecek. Yükseltme yapabilir veya iptal edebilirsiniz.',
        link: '/settings',
        isRead: false,
      },
      {
        ...
        message:
          'Cari, Stok, Satış, Sipariş, Tahsilat, Kasa, Banka ve Raporlar modülleri hesabınıza tanımlandı.',
        isRead: true,
      ...
      },
      {
        ...
        message:
          'Yarın 03:00-04:00 (UTC) saatleri arasında planlı bakım yapılacak. Kısa süreli kesintiler olabilir.',
        isRead: false,
      ...
      },
      {
        ...
        message:
          'Sistem 0.2.0 sürümüne güncellendi. Yeni özellikler: gelişmiş raporlar, performans iyileştirmeleri.',
        isRead: true,
